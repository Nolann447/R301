...
<head>
    ...
    <title>exo2-regions</title>
</head>
<body>
    <h1>Liste des départements avec leur région</h1>
    ...
    <table >
        ...
        <tbody>
            <?php foreach ($depts as $code => $valeur) { ?>
                <tr>
                    <td><?php echo $valeur[0]; ?> (<?php echo trouve_region($code); ?>)</td>
                </tr>
            <?php } ?>
        </tbody>
    </table>
